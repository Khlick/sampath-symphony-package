classdef plotEpoch < symphonyui.core.FigureHandler
    ...
    methods
        ...
        function obj = plotEpoch(device, varargin)
        ...
        function setTitle(obj, t)
            ...
            if isempty(obj.customTitle)
                obj.customTitle = title(obj.axesHandle, t);
            end
        end
        
        function setAxTitle(obj,t)
            if isempty(obj.customTitle)
                obj.customTitle = title(obj.axesHandle, t);
            else
                set(obj.customTitle, 'String', t);
            end
        end
        ...
        function handleEpoch(obj, epoch)
            ...
            amplitudeProp = epoch.parameters.keys;
            amplitudeProp = amplitudeProp{...
                    ~cellfun(@isempty,...
                        strfind(amplitudeProp,'Amplitude'),'unif',1 ...
                        )...
                    };
            amplitudeVal= epoch.parameters(amplitudeProp);
            if isnumeric(amplitudeVal), amplitudeVal = num2str(amplitudeVal); end
            obj.setAxTitle(sprintf('%s - %s',...
                obj.device.name,...
                amplitudeVal));
